...
from src.services.diagnostico.diagnostico import (
    Diagnostico,
    TipoDiagnostico,
    SeveridadeDiagnostico,
    RedeNeuralDiagnostico
)
from src.services.diagnostico.diagnostico_sistema import DiagnosticoSistema
from src.services.diagnostico.core import AnalisadorMetricas, GeradorDiagnosticos
