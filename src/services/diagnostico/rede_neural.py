...
import logging
from src.services.monitoramento.coletor_metricas import Metrica
...
class DiagnosticoSistema:
    """Stub para compatibilidade. Substitua pela implementação real se necessário."""
    pass 

RedeNeuralDiagnostico = RedeNeuralAltaOrdem 