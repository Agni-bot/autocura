...
kind get clusters | findstr "autocura" >nul
if %ERRORLEVEL% EQU 0 (
    echo Cluster 'autocura' já existe. Excluindo...
...
echo Criando cluster kind 'autocura'...
...
echo Cluster kind 'autocura' criado com sucesso!
