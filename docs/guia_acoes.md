...
Este guia descreve as ações disponíveis no Sistema de Autocura Cognitiva e como utilizá-las. O módulo gerador é responsável por analisar diagnósticos e gerar recomendações de ações apropriadas.
