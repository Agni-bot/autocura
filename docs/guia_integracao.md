...
## Integração do Portal com o Will

- O portal consome o Will via variável de ambiente WILL_URL (ex: http://will:5000).
- Endpoints principais expostos no portal:
  - /api/will/status
  - /api/will/decision
  - /api/will/news/sentiment/{par}
  - /api/will/analysis
- As rotas do Will foram migradas para FastAPI para padronização e integração nativa.
- O dashboard do portal terá botões de acesso rápido para facilitar testes e uso dos serviços do Will. 
