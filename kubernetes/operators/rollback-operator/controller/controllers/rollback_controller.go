...
// +kubebuilder:rbac:groups=rollback.autocura.io,resources=rollbackpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=rollback.autocura.io,resources=rollbackpolicies/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=rollback.autocura.io,resources=rollbackpolicies/finalizers,verbs=update
...
=======
		rollbackPolicy.Status.CurrentRevisions[resourceKey] = int32(deployment.Status.ObservedGeneration)
>>>>>>> origin/main
...
=======
				rollbackPolicy.Status.RollbackRevisions[resourceKey] = int32(deployment.Status.ObservedGeneration)
>>>>>>> origin/main
			}
		}
	}
