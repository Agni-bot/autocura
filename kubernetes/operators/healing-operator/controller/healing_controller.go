...
// +kubebuilder:rbac:groups=healing.autocura.io,resources=healingpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=healing.autocura.io,resources=healingpolicies/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=healing.autocura.io,resources=healingpolicies/finalizers,verbs=update
